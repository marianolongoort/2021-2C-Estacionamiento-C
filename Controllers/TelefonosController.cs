...
namespace EstacionamientoMVC.Controllers
{
    public class TelefonosController : Controller
    {
        ...
        {
            var garageContext = _context.Telefonos.Include(t => t.Persona);
        ...
        {
            ViewData["PersonaId"] = new SelectList(_context.Clientes, "Id", "NombreCompleto");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CodArea,Numero,Principal,Tipo,PersonaId")] Telefono telefono)
        {
            ...
            ViewData["PersonaId"] = new SelectList(_context.Clientes, "Id", "NombreCompleto", telefono.PersonaId);
            return View(telefono);
        }
