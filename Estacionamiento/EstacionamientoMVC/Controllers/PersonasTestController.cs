...
namespace EstacionamientoMVC.Controllers
{
    public class PersonasTestController : Controller
    {
        ...
        public PersonasTestController(EstacionamientoContext context)
        {
            _context = context;
        }
        ...
        // GET: PersonasTest/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PersonasTest/Create
